...
def main(args):
    ...
    snn_setting = {'timesteps': args.timesteps, 'train_Vth': True if args.train_Vth == 1 else False,
                   'Vth': args.Vth, 'tau': args.tau, 'delta_t': args.delta_t, 'alpha': args.alpha,
                   'Vth_bound': args.Vth_bound, 'rate_stat': True if args.rate_stat == 1 else False}
